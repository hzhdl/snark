...
const getCurveFromR = async function (r) {
    let curve;
...
const getCurveFromQ = async function (q) {
    let curve;
...
const getCurveFromName = async function (name) {
    let curve;
...
module.exports={getCurveFromR,getCurveFromQ,getCurveFromName}
